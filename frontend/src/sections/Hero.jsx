    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <Container className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          {/* Social Links — driven by socials.js */}
          <div className="mt-6 pt-6 border-t border-border/40 w-fit">
            <SocialRow placement="hero" />
          </div>
        </motion.div>

        {/* Cinematic Manga Visual Panel — driven by settings.js */}
        <motion.div
        ...
        >
          <div className="absolute inset-0 border border-border bg-panel overflow-hidden group">
            ...
            <div className="absolute top-8 right-8 bg-bg border border-border p-6 shadow-2xl">
              ...
              <p className="text-xs text-muted mt-4">{hero.taglineEN}</p>
            </div>
