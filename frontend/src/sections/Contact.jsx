          ...
          <div className="flex flex-col gap-8">
            <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
              <input 
                ...
                className="w-full bg-transparent border-b border-border py-4 px-2 focus:outline-none focus:border-accent transition-colors placeholder:text-muted/50 font-light"
              />
              <input 
                type="email" 
              ...
              <textarea 
                ...
                rows="4"
                className="w-full bg-transparent border-b border-border py-4 px-2 focus:outline-none focus:border-accent transition-colors placeholder:text-muted/50 font-light resize-none"
              ></textarea>
              
              <button className="group self-start flex items-center gap-4 px-8 py-4 bg-secondary text-primary hover:scale-105 transition-transform duration-300 mt-4">
                <span className="font-medium tracking-widest uppercase text-sm">Send Message</span>
